...
public class Tests {
	...
	public static void main(String[] args) {
		...
		String printingName = "All models";

		testingAndWritingToFile(printingName + ".csv",listOdModelsToPrintInFile);
