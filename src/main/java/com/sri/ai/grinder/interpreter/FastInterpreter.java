...
/**
 * A hard-coded interpreter faster than {@link BruteForceInterpreter}.
 * Currently supports only basic addition and boolean operations.
 * 
 * @author braz
 *
 */
public class FastInterpreter implements BinaryFunction<Expression, Context, Expression> {

	private Map<String, Function<ArrayList<Expression>, Expression>> functorOperations;

	public FastInterpreter() {
	...
	private Expression evaluateSymbol(Expression expression, Context context) throws Error {
	...
	private Expression evaluateVariable(Expression expression, Context context) throws Error {
	...
	private
	Expression
	evaluate(Function<ArrayList<Expression>, Expression> functorOperation, Expression expression, Context context) {
		var evaluatedArguments = mapIntoArrayList(expression.getArguments(), a -> apply(a, context));
		var resultingValue = functorOperation.apply(evaluatedArguments);
	...
	public static void main(String[] args) {
		...
		var fastInterpreter = new FastInterpreter();
