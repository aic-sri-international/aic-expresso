...
import static com.sri.ai.grinder.library.set.extensional.ExtensionalSets.getElements;
import static com.sri.ai.grinder.library.set.extensional.ExtensionalSets.removeNonDestructively;
...
public class DefaultExtensionalBound extends AbstractExtensionalBound {
	...
	static public DefaultExtensionalBound boundProduct(Theory theory, Context context, Bound... listOfBounds) {		
		...
		List<NullaryFunction<Iterator<? extends Expression>>> iteratorForBoundList = 
