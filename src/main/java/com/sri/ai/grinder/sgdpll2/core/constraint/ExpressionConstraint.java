...
/**
 * An {@link Constraint2} based on a given expression.
 * Unlike other implementations of {@link Constraint2}, this does not keep
 ...
 *
 */
public class ExpressionConstraint extends AbstractExpressionWrapper implements Constraint2 {
	...
	@Override
	public Constraint2 conjoinWithLiteral(Expression literal, RewritingProcess process) {
