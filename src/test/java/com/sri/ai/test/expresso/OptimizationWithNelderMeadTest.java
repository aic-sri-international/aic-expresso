...
import com.sri.ai.expresso.optimization.OptimizationWithNelderMead;
...
public class OptimizationWithNelderMeadTest {
	...
	public static boolean optAreEquals(double expectedResult, String stringToMinimize, double[] initialGuess) {
		OptimizationWithNelderMead minWithNM = new OptimizationWithNelderMead(Expressions.parse(stringToMinimize), GoalType.MINIMIZE, initialGuess);
		double minimumOfExpression = minWithNM.findOptimum();
	...
	public static boolean argoptAreEquals(double[] expectedResult, String stringToMinimize, double[] initialGuess) {
		OptimizationWithNelderMead minWithNM = new OptimizationWithNelderMead(Expressions.parse(stringToMinimize), GoalType.MINIMIZE, initialGuess);
		double[] argminOfExpression = minWithNM.findArgopt();
