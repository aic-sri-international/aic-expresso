...
public class DefaultSymbolTest {
	...
	public void testDisplayExact() {
		...
		DefaultSyntaxLeaf.use2 = true;
	}
	
	@Test
	public void testDisplayExact2() {
	...
	@Test
	public void testDisplayLargeExact2() {
	...
	@Test
	public void testDisplayLargeApproximateNumber2() {
	...
	@Test
	public void testPrecisionOutput2() {			
		...
		Assert.assertEquals("11.02",       Expressions.makeSymbol(new Rational(110176, 10000)).toString()); // 11.0176
		Assert.assertEquals("11.92",       Expressions.makeSymbol(new Rational(11923, 1000)).toString()); // 11.923
		Assert.assertEquals("19.42",       Expressions.makeSymbol(new Rational(19423, 1000)).toString()); // 19.423
		Assert.assertEquals("19.93",       Expressions.makeSymbol(new Rational(19926, 1000)).toString());	// 19.926	
		Assert.assertEquals("0.5",         Expressions.makeSymbol(0.5).toString());
		Assert.assertEquals("1",           Expressions.makeSymbol(0.999).toString());
		Assert.assertEquals("11",          Expressions.makeSymbol(new Rational(10999, 1000)).toString()); // 10.999
		Assert.assertEquals("20",          Expressions.makeSymbol(new Rational(19999, 1000)).toString()); // 19.999
